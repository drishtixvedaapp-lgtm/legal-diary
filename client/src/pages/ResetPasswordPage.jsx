...
import { Eye, EyeOff, Lock, ArrowRight, ArrowLeft, KeyRound, AlertTriangle } from "lucide-react";
      ...
      <div style={{
        ...
        <form onSubmit={handleSubmit} style={{ display:"flex", flexDirection:"column", gap:20 }}>
          <div style={{ display:"flex", flexDirection:"column", gap:6 }}>
            ...
            <div style={{
              ...
              <input name="newPassword" type={showPassword ? "text" : "password"}
                placeholder="At least 8 characters" value={formData.newPassword} required
          ...
          <div style={{ display:"flex", flexDirection:"column", gap:6 }}>
            ...
            <div style={{
              ...
              <input name="confirmPassword" type={showPassword ? "text" : "password"}
                placeholder="Re-enter new password" value={formData.confirmPassword} required
                onChange={handleChange}
                style={{ flex:1, padding:"15px 0", background:"transparent", border:"none", outline:"none",
                         fontSize:14, color:"#fff", fontFamily:"'Inter',sans-serif" }} />
            </div>
              ...
              <div>
                ...
                {tokenInvalid && (
                  <p style={{ margin:"4px 0 0", fontSize:12.5, color:"rgba(255,255,255,0.45)", lineHeight:1.6 }}>
                    ...
                    <Link to="/forgot-password" style={{ color:"#60a5fa", fontWeight:600, textDecoration:"none" }}>
                      Request a new one
                    </Link>
                  </p>
                )}
          ...
          <button type="submit" disabled={loading}
            ...
            {loading ? <><Spinner/>Resetting…</> : <>Reset Password &nbsp;<ArrowRight size={16}/></>}
          </button>
        </form>
